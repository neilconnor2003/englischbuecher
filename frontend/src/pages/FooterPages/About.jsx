...
const About = () => {
  ...
  const mission =
    lang === 'de' ? about.mission_de : about.mission_en;

  const story =
    lang === 'de' ? about.story_de : about.story_en;

  // Optional images from API (if you add them later in admin)
  ...
  const values = ['quality', 'service', 'speed'].map((key) => ({
    title:
      lang === 'de'
        ? about[`values_${key}_de`]
        : about[`values_${key}_en`],
    text:
      lang === 'de'
        ? about[`values_${key}_text_de`]
        : about[`values_${key}_text_en`],
  }));
      ...
      <div className="about-content">
        ...
        <section className="mission">
          ...
          <p>{mission || (lang === 'de'
            ...
            : 'We make English books easy to access in Germany — carefully curated, fast delivered, and built with a genuine love for reading.')}</p>
        </section>
        ...
        <section className="story">
          <div className="story-text">
            ...
            <div style={{ marginTop: 20, display: 'grid', gap: 10 }}>
              <div style={{ background: '#fff', padding: 14, borderRadius: 12, boxShadow: '0 6px 18px rgba(0,0,0,0.06)' }}>
          ...
          <div className="story-image">
            <img src={storyImage} alt="Books and reading" />
          </div>
        </section>
