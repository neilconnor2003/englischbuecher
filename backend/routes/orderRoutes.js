...
async function sendAdminOrderNotification({ transporter, order, user, orderId }) {
    try {
    ...
    `;
        ...
        await transporter.sendMail({
            from: `"EnglischBücher Orders" <${process.env.SMTP_USER}>`,
            to: toEmail,
    ...
    router.post('/', async (req, res) => {
        ...
        WHERE id = ?`,
          ...
          `, [userId, safeWalletUse, 'Used in order #' + orderId]);
            ...
            sendAdminOrderNotification({ transporter, order: fullOrder, user: orderUser, orderId });
